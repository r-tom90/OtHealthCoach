export const education = [
  ...
  {
    degree: "Child-Centred Play Therapy Training",
    school: "Play Therapy Australia",
    year: "2020",
  },
  {
    degree: "Certified Holistic Health Coach",
    school: "HMI Nutrition School",
    year: "2021",
  },
  {
    degree: "Certified Sports Performance Coach",
    school: "National Sports Performance Association",
    year: "2022",
  },
];
...
export const points = [
  ...
  },
  {
    ...
    points: [
      "Goal-setting and strategies for independence and success.",
      "Improving energy levels, focus, endurance and overall health and wellbeing.",
      "Strategies to work through feelings of anxiousness, low mood and apathy, and more.",
    ],
  },
];
